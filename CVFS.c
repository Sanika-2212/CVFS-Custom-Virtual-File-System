...
void ManPageDisplay(char Name[])
{
    ...
    else if(strcmp(Name,"stat") == 0)
    {
        ...
        printf("File_Name : Name of file whose inforation should be fetch\n");
    }
    else
    {
        ...
        else if(iCount == 2)
        {
            ...
            else if(strcmp(Command[0],"write") == 0)
            {
                ...
                if(iRet == ERR_INVALID_PARAMETER)
                {
                    ...
                    printf("Please refer to the manpage manual");
                }
                ...
                {
                    printf("%d bytes return successfully written into the file\n",iRet);
                }
            }
            else
            {
